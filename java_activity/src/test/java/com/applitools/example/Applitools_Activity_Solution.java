...
public class Applitools_Activity_Solution {
    ...
    public void ultraFastTest() {
        ...
        try {
            ...
            By applicationSelector = new By.ById("appContainer");
            eyes.check(Target.region(applicationSelector).withName("Dashboard"));
